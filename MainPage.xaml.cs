...
public partial class MainPage : ContentPage
{
    ...
    {
        base.OnAppearing();
        this.MyCollectionView.ItemsSource = Enumerable.Range(0, 20).Select(i => new MyClass()).ToList();
    }
}
...
public class MyClass
{
    public FormattedString FormattedString
    {
        get
        {
            ...
            {
                CommandParameter = "https://www.forbes.com/sites/forbeshumanresourcescouncil/2024/04/11/3-actionable-steps-for-managers-to-cultivate-a-learning-culture/",
            ...
            return new FormattedString
            {
                Spans =
                {
                    ...
                    new Span
                    {
                        ...
                        FontFamily = "GilroyLight", FontSize = 14, TextColor = Colors.LightSkyBlue, TextDecorations = TextDecorations.Underline
                    }
                }
            };
        }
